...
import com.sundeinfo.sypglass.dto.PasswordDto;
        ...
        return requestHandler.doPost(
                new PostCheckResultCallback() {
                    ...
                    public RequestState invoke() throws Exception {
                        ...
                        String presentedPassword = authenticationGetter.getAnyUser().getUser().getPassword();
                        if(!MD5.checkPassword(presentedPassword, passwordDto.getPassword())) {
