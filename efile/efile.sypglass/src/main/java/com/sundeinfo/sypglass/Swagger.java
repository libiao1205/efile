...
public class Swagger {
    ...
    public Docket allApis() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .groupName("all")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.sundeinfo.sypglass.apis"))
    ...
    public Docket admin() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .groupName("admin")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.sundeinfo.sypglass.apis.admin"))
                .paths(PathSelectors.any())
                .build().globalOperationParameters(parameters);
    }
    ...
    public Docket user() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .groupName("user")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.sundeinfo.sypglass.apis.user"))
                .paths(PathSelectors.any())
                .build().globalOperationParameters(parameters);
    }
