...
public class BlockedFileHistory {
    ...
    public BlockedFileHistory(Long sequence, Long id, Long fileid, Integer seq, Long folderid, String name, String suffix, String size, Long userid, String username, Date updatedate, String comment, String saveid, String savemd5, Long savelength) {
