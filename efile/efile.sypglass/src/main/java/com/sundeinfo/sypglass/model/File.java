...
public class File {
    ...
    public String getOafileinfo() {
        return oafileinfo;
    }

    public void setOafileinfo(String oafileinfo) {
        this.oafileinfo = oafileinfo == null ? null : oafileinfo.trim();
    }

    public String getRankauthor() {
        return rankauthor;
    }

    public void setRankauthor(String rankauthor) {
        this.rankauthor = rankauthor == null ? null : rankauthor.trim();
    }
    ...
    public void setRanksource(String ranksource) {
        this.ranksource = ranksource == null ? null : ranksource.trim();
    }
}