                ...
                new ResponseCheckResultCallback<RegisterDto>() {
                    ...
                    public RequestState invoke() throws Exception {
                        ...
                        if(i > 0) {
                            ...
                            if (registerDto.getAdmin() != null && registerDto.getAdmin().getLevel() > 0){
                                registerDto.getAdmin().setUserId(registerDto.getId());
                                registerDto.getAdmin().setDeptId(registerDto.getDeptId());
                                registerDto.getAdmin().setStatus((byte)1);
                                adminService.save(registerDto.getAdmin());
                            }
                            return RequestState.SUCCESS;
                        }else{
