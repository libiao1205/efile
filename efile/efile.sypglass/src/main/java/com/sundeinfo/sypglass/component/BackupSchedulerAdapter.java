...
import com.sundeinfo.sypglass.model.QuartzSettingExample;
...
@Component("BackupSchedulerAdapter")
public class BackupSchedulerAdapter extends JobScheduler<BackupSchedulerAdapter> {
    ...
    public List<QuartzSetting> findBackupJobSettings(){
