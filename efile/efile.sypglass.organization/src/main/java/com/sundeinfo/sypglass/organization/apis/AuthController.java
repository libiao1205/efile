...
import com.sundeinfo.sypglass.organization.dto.AuthenticationResponseDto;
import com.sundeinfo.sypglass.organization.dto.UserDto;
import com.sundeinfo.sypglass.organization.log.LoginLogInfo;
import com.sundeinfo.sypglass.organization.model.Config;
import com.sundeinfo.sypglass.organization.model.User;
import com.sundeinfo.sypglass.organization.service.AuthService;
...
public class AuthController extends AbstractController<AuthController> {
    ...
    public ResponseEntity<Result<AuthenticationResponseDto>> createToken(
            HttpServletRequest request,String username,String password) throws AuthenticationException {

        return requestHandler.doPost(
                new ResponseCallback<AuthenticationResponseDto>() {
                    String token = "";
                    String mistakeCount = "";
                    @Override
                    public AuthenticationResponseDto response() throws Exception {
    ...
    private AuthenticationResponseDto createJwtAuthenticationResponse(String token,String mistakeCount){
        ...
        response.setUserId(anyUser.getUser().getId());
        response.setUsername(anyUser.getUser().getUsername());
